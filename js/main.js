!function (a) {
  ...
  function d() {
    g.hasClass(k) ? (h.addClass(l), g.animate({left: "0px"}, p), i.animate({left: q}, p), j.animate({left: q}, p)) : (h.addClass(m), g.animate({right: "0px"}, p), i.animate({right: q}, p), j.animate({right: q}, p)), o && o.focus()
  }
  ...
  var g = a(".pushy"), h = a("body"), i = a("#container"), j = a(".push"), k = "pushy-left", l = "pushy-open-left",
    m = "pushy-open-right", n = a(".site-overlay"), o = a(g.data("focus")), p = 200, q = g.width() + "px",
    r = ".pushy-submenu", s = "pushy-submenu-open", t = "pushy-submenu-closed";
  a(r);
  if (void 0 !== g.data("menu-btn-class")) var u = g.data("menu-btn-class"); else var u = ".menu-btn";
  var v = a(u + ", .pushy-link"), w = a(u);
  ...
  if (x) f(), v.on("click", function () {
    ...
    h.addClass("no-csstransforms3d"), g.hasClass(k) ? g.css({left: "-" + q}) : g.css({right: "-" + q}), i.css({"overflow-x": "hidden"});
    var y = !1;
